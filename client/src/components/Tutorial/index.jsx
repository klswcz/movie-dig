        ...
        <div className="mt-16 grid grid-cols-1 pb-14">
            <div className="w-11/12 md:w-3/4 2xl:w-1/2 place-self-center">
                <div>
                    ...
                    <div className="mb-10 border shadow-md px-3 py-5 rounded-md">
                    <p className="mb-3 font-bold">2. In order to see personalised recommendations you need to give at least 20 ratings.</p>
                    </div>
                    <div className="mb-10 border shadow-md px-3 py-5 rounded-md">
                    <p className="mb-3 font-bold">3. Search for movies using search box on the navigation bar.</p>
                    <img src={searchBar} alt="Application screenshot" className="rounded-t-md ml-auto mr-auto mb-3 xl:mb-0 w-full"/>
                    </div>
                    <div className="mb-10 border shadow-md px-3 py-5 rounded-md">
                    <p className="mb-3 font-bold">4. Access the list of rated movies, check the wishlist or change your account settings by clicking the Account button on the navigation bar.</p>
                    <img src={account} alt="Application screenshot" className="rounded-t-md ml-auto mr-auto mb-3 xl:mb-0 w-full"/>
                    </div>
                    <div className="mb-10 border shadow-md px-3 py-5 rounded-md">
                    <p className="font-bold">5. If you are interested in seeing source code of the website, please visit my GitHub page (link in the footer).</p>
                    </div>
                </div>
