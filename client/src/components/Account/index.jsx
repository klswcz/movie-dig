    ...
    return (
        <div className=" pb-14 mt-16 grid grid-cols-1">
            <div className="w-11/12 sm:w-96 place-self-center">
                <div>
                    <h1 className="pt-5 text-center text-3xl font-extrabold text-gray-900">Update account details</h1>
                </div>
                ...
                <Button
                    onClick={destroy}
                    label={"Remove account and all activity"}
                    customClass={"mt-3"}
                    customColor={"bg-red-600 hover:bg-red-700"}
                />
            </div>
        </div>
    )
